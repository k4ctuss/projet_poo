...
public class TestConwaySimulator {
     ...
     * @return un ensemble de cellules représentant un glider vivant (state=1)
     */
    static Set<Cell> buildGlider(int x0, int y0){
        Set<Cell> glider = new HashSet<>();
        glider.add(new Cell(x0+1, y0, 1));
        glider.add(new Cell(x0+2, y0+1, 1));
        glider.add(new Cell(x0, y0+2, 1));
        glider.add(new Cell(x0+1, y0+2, 1));
        glider.add(new Cell(x0+2, y0+2, 1));
    ...
    public static void main(String[] args) {
        ...
        // cell pour la forme de l'exemple du sujet (state=1 pour vivant)
        initCells.add(new Cell(11, 11, 1));
        initCells.add(new Cell(11, 12, 1));
        initCells.add(new Cell(12, 11, 1));
        initCells.add(new Cell(13, 12, 1));
        initCells.add(new Cell(14, 14, 1));
